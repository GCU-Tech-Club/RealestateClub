...
const EventCarouselComponent = () => {
    return(
        ...
        <div id="event-carousel" className="mt-24 relative w-full h-fit bg-gray-500" data-carousel="static">
            {/* Items */}
            ...
            <button type="button" className="w-12 h-12 bg-black-500" data-carousel-next></button>
